...
//TODO https://github.com/googlemaps/android-samples/tree/master/ApiDemos/kotlin/app/src/main/java/com/example/kotlindemos
//TODO https://developers.google.com/maps/documentation/android-sdk/map-with-marker
    ...
    *//**
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        with(map) {
            ...
            setOnInfoWindowClickListener(this@MapActivity)
            setOnMarkerDragListener(this@MapActivity)
            setOnInfoWindowCloseListener(this@MapActivity)
            setOnInfoWindowLongClickListener(this@MapActivity)
